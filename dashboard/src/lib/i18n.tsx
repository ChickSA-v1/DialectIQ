...
const translations = {
  en: {
    ...
    "payment.bankName": "Bank: Al Rajhi Bank",
    "payment.accountName": "Account Name: DataWeave Co.",
    "payment.iban": "IBAN: SA0380000000608010167519",
  ...
  ar: {
    ...
    "payment.bankName": "البنك: بنك الراجحي",
    "payment.accountName": "اسم الحساب: شركة داتا ويف",
    "payment.iban": "آيبان: SA0380000000608010167519",
