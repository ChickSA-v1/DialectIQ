...
const translations = {
  en: {
    ...
    "team.emailPlaceholder": "Email Address",
    "team.passwordPlaceholder": "Password",
    "team.sendInvite": "Add Member",
    "team.confirmRemove": "Remove {name} from your team?",
    "team.owner": "Owner",
    "team.member": "Member",
    ...
    "admin.packageDistribution": "Package Distribution",
    "admin.recentActivity": "Recent Activity",
    "admin.pendingAlerts": "Pending Alerts",
    "admin.pendingRegistrations": "Pending Registrations",
    "admin.pendingBankTransfers": "Pending Bank Transfers",
    "admin.sar": "SAR",
    "admin.noActivity": "No recent activity",

    // Admin Invoices
    "admin.invoices": "Invoices",
    "admin.invoiceNumber": "Invoice #",
    "admin.tenant": "Tenant",
    "admin.amount": "Amount",
    "admin.vat": "VAT",
    "admin.total": "Total",
    ...
    "admin.createInvoice": "Create Invoice",
    "admin.selectTenant": "Select Tenant",
    "admin.selectPackage": "Select Package",
    "admin.customAmount": "Custom Amount (SAR)",
    "admin.invoiceCreated": "Invoice created successfully",
    "admin.noInvoices": "No invoices found",
    ...
    // Admin Delete
    "admin.delete": "Delete",
    "admin.confirmDelete": "Are you sure you want to delete this tenant? This action will revoke their API key and deactivate all users.",
    "admin.deleted": "Tenant deleted successfully",
    "admin.showDeleted": "Show Deleted",

    // Admin Reports
    "admin.reports": "Reports",
    "admin.revenueReport": "Revenue",
    "admin.tenantsReport": "Tenants",
    "admin.vatReport": "VAT",
    "admin.exportCsv": "Export CSV",
    "admin.month": "Month",
    "admin.invoiceCount": "Invoice Count",
    "admin.revenue": "Revenue",
    "admin.subscription": "Subscription",
    "admin.expiresAt": "Expires At",
    "admin.reviewsUsage": "Reviews Usage",
    ...
    "tutorial.stepTrendTitle": "Sentiment Trend",
    "tutorial.stepTrendDesc": "Track how your customer sentiment changes over the last 30 days. See if your improvements are working.",
    "tutorial.stepCompetitorTitle": "Competitor Comparison",
    "tutorial.stepCompetitorDesc": "Add up to 3 competitors to compare ratings and review counts. Know where you stand in your market.",
    ...
    "section.competitors": "Competitor Comparison",
    "competitor.your": "Your Businesses",
    "competitor.rivals": "Competitors",
    "competitor.add": "Add Competitor",
    "competitor.addFirst": "Add Your First Competitor",
    "competitor.empty": "Add competitors to compare ratings and reviews",
    "competitor.search": "Search for a competitor",
    "competitor.searchPlaceholder": "Enter business name or Google Maps link",
    "competitor.addBtn": "Add",
    "competitor.noBusinesses": "Add a business first to enable competitor comparison",
  ...
  ar: {
    ...
    "team.inviteNew": "إضافة عضو جديد",
    "team.namePlaceholder": "الاسم الكامل",
    "team.emailPlaceholder": "البريد الإلكتروني",
    "team.passwordPlaceholder": "كلمة المرور",
    "team.sendInvite": "إضافة العضو",
    "team.confirmRemove": "إزالة {name} من فريقك؟",
    "team.owner": "مالك",
    "team.member": "عضو",
    ...
    "admin.activeTenants": "المنشآت النشطة",
    "admin.totalReviews": "إجمالي المراجعات",
    "admin.activeSubscriptions": "الاشتراكات النشطة",
    "admin.revenueTrend": "اتجاه الإيرادات",
    "admin.packageDistribution": "توزيع الباقات",
    "admin.recentActivity": "آخر النشاطات",
    "admin.pendingAlerts": "تنبيهات معلقة",
    "admin.pendingRegistrations": "طلبات تسجيل معلقة",
    "admin.pendingBankTransfers": "تحويلات بنكية معلقة",
    "admin.sar": "ر.س",
    "admin.noActivity": "لا توجد نشاطات حديثة",

    // Admin Invoices
    "admin.invoices": "الفواتير",
    "admin.invoiceNumber": "رقم الفاتورة",
    "admin.tenant": "المنشأة",
    "admin.amount": "المبلغ",
    "admin.vat": "الضريبة",
    ...
    "admin.createInvoice": "إنشاء فاتورة",
    "admin.selectTenant": "اختر المنشأة",
    "admin.selectPackage": "اختر الباقة",
    "admin.customAmount": "مبلغ مخصص (ر.س)",
    "admin.invoiceCreated": "تم إنشاء الفاتورة بنجاح",
    "admin.noInvoices": "لا توجد فواتير",
    "admin.allInvoices": "جميع الفواتير",
    "admin.dateFrom": "من تاريخ",
    "admin.dateTo": "إلى تاريخ",

    // Admin Delete
    "admin.delete": "حذف",
    "admin.confirmDelete": "هل أنت متأكد من حذف هذه المنشأة؟ سيتم إلغاء مفتاح API وتعطيل جميع المستخدمين.",
    "admin.deleted": "تم حذف المنشأة بنجاح",
    "admin.showDeleted": "عرض المحذوفة",

    // Admin Reports
    "admin.reports": "التقارير",
    "admin.revenueReport": "الإيرادات",
    "admin.tenantsReport": "المنشآت",
    "admin.vatReport": "الضريبة",
    "admin.exportCsv": "تصدير CSV",
    "admin.month": "الشهر",
    "admin.invoiceCount": "عدد الفواتير",
    "admin.revenue": "الإيرادات",
    "admin.subscription": "الاشتراك",
    "admin.expiresAt": "ينتهي في",
    "admin.reviewsUsage": "استخدام المراجعات",
    ...
    "tutorial.stepTrendTitle": "اتجاه المشاعر",
    "tutorial.stepTrendDesc": "تابع كيف تتغير مشاعر عملائك خلال آخر 30 يوم. شاهد هل التحسينات شغّالة.",
    "tutorial.stepCompetitorTitle": "مقارنة بالمنافسين",
    "tutorial.stepCompetitorDesc": "أضف حتى 3 منافسين لمقارنة التقييمات وعدد المراجعات. اعرف موقعك في السوق.",
    ...
    "section.competitors": "مقارنة بالمنافسين",
    "competitor.your": "أعمالك",
    "competitor.rivals": "المنافسون",
    "competitor.add": "أضف منافس",
    "competitor.addFirst": "أضف أول منافس",
    "competitor.empty": "أضف منافسين لمقارنة التقييمات والمراجعات",
    "competitor.search": "ابحث عن منافس",
    "competitor.searchPlaceholder": "اسم النشاط التجاري أو رابط قوقل ماب",
    "competitor.addBtn": "أضف",
    "competitor.noBusinesses": "أضف نشاطك التجاري أولاً لتفعيل مقارنة المنافسين",
